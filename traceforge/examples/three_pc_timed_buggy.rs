...
//! atomicity bug. Companion to `three_pc_timed.rs`.
//!
...
//!     cargo run --release --example three_pc_timed_buggy -- --participants 3 --u 1 --w-ratio 2
//!     cargo run --release --example three_pc_timed_buggy -- --participants 3 --crashes
//!     cargo run --release --example three_pc_timed_buggy -- --participants 3 --replay
