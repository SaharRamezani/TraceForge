...
//! execution of the 2PC into a viz_out/two_pc_correct/
//! directory.
//!
...
fn main() {
    ...
    let description = format!(
        "Correct 2PC (N={}, timed mode): coordinator commits iff every participant \
         voted Yes (unanimity). Same protocol skeleton, same timed staggering as the \
